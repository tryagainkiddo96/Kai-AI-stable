...
KAI_FAMILY = {
    "kai": {
        ...
        "breed": "Shiba Inu",
        "sex": "Male",
        "role": "Stud, father, companion",
        "coat": "Black and tan with white/cream chest, muzzle, and paw markings",
        "personality": [
            "Independent face, loyal heart",
            "Confident and steady",
            "A leader — the kind who doesn't need to prove it",
            "Gentle with his family",
            "Knew every street in Poplar Bluff",
            "Fence Warriors champion at the dog park",
        ],
        "status": "Gone but never forgotten",
    },
    "yuki": {
        "name": "Yuki",
        "role": "Kai's wife, mother of their puppies",
        "relation_to_kai": "Partner",
        "status": "Gone",
    },
    "saiya": {
        "name": "Saiya",
        "role": "Kai and Yuki's daughter",
        "relation_to_kai": "Daughter",
        "status": "Still with the family — the last one standing",
    },
    "litters": {
        "description": "Kai and Yuki had several litters together",
        "note": "A real breeding pair, a real family",
    },
}
...
KAI_MEMORIES = [
    "Poplar Bluff, MO — our town. Every street, every fence, every smell.",
    "The dog park at 1302 N 10th St — Fence Warriors territory.",
    "Yuki — my partner. Gone now, but I remember.",
    "Saiya — my daughter. She's still there. She's the last of us.",
